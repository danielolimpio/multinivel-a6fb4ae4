...
export function FlagIcon({ countryCode, className = '', size = 'md' }: FlagIconProps) {
  const flagImages: Record<string, string> = {
    'pt': '/lovable-uploads/4d720d79-b4b3-494c-b4d5-81a40f3cf498.png', // Brasil
    ...
    'mx': '/lovable-uploads/8dbe0995-16b7-4ed3-b106-f36325e58983.png', // México
    'ca': '/lovable-uploads/84bbf665-d8d7-4123-96b8-b5c284471a45.png', // Canadá
    ...
    'ja': '/lovable-uploads/eb8e05f4-9df5-4565-8cc5-f6adee4d7340.png', // Japão
