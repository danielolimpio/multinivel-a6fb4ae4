    ...
    <Head>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "Organization",
          "name": SITE_NAME,
          "alternateName": ["UniversidadeMN", "Universidade MMN", "Portal Marketing Multinível"],
          "url": SITE_URL,
          "logo": `${SITE_URL}/lovable-uploads/c97e9d14-38f3-4d57-893a-6c9fb7a9b604.png`,
          "foundingDate": "2014",
          "description": "Portal autoridade em Marketing Multinível (MMN), Marketing de Rede e Network Marketing (MLM) no Brasil desde 2014. Mais de 20 anos de experiência vivenciada no setor de vendas diretas.",
          "knowsAbout": [
            ...
            "Top Earners",
            "Pirâmide Financeira vs Marketing Multinível"
          ],
          "sameAs": [
